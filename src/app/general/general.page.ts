...
export class GeneralPage implements OnInit {
  ...
  GeneralNews: any = []; // News Array
  country: string; // country selected

  constructor(private getGeneralNews:NewsService, private browser:BrowserTab, private storage:Storage) { }
  ...
  getNewsByCountry(coun: string) {
    this.getGeneralNews.GetGeneralNews(this.country).subscribe((data)=> {
